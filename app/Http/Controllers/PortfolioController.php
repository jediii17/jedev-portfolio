...
class PortfolioController extends Controller
{
    public function index(): View
    {
        ...
        $skills = [
            ...
            'DevOps & Cloud' => ['Azure Data Studio', 'Docker', 'GitHub Actions', 'OpenAI']
        ];
        ...
        $experience = [
            [
                ...
                'period' => '2024 - Present',
                'description' => '',
                // 'tech' => ['Laravel', 'Vue.js', 'Inertia.js', 'Node.js', 'Spatie Multitenancy']
            ],
            [
                ...
                'period' => '2024',
                'description' => '',
                // 'tech' => ['Laravel', 'Blade', 'Livewire', 'MySQL', 'Bootstrap']
            ],
            [
        ...
        $certification = array_slice($this->getCertifications(), 0, 4);

        $recommendations = [
            [
                'text' => 'Jed is a good student and software developer who shows professionalism and dedication in whatever he does. His software projects during his academic years are up to standard and is being used by the university for some of its operations. Jed also...',
    ...
    {
        $skills = [
            'Frameworks' => ['Laravel', 'Vue.js', 'Inertia.js', 'Livewire', 'Tailwind CSS', 'Express.js', 'Node.js', 'Alpine.js', 'Flask'],
            'Tools & Platforms' => ['Git/GitHub/GitLab', 'Docker', 'MySQL', 'PostgreSQL', 'SQL Server', 'Firebase', 'Google Cloud', 'Raspberry Pi', 'OpenAI'],
            'Other' => ['RESTful APIs', 'WebSockets', 'Spatie Packages', 'MVC Architecture', 'OOP', 'YOLOv8', 'OpenCV']
        ];
